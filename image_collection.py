...
from motor_controls import stepper_motor
...
def control_servos():
    ...
    controller.servo_2.value = math.sin(math.radians(230))
    controller.servo_1.value = math.sin(math.radians(183))
    while True:
